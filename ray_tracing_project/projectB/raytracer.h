...
typedef struct {
  enum  { SPHERE, POSTER, CYLINDER } tag;
...
/* ========================================= */ 
/* === cylinder operations => cylinder.c === */ 
/* ========================================= */ 
 ...
 * Otherwise, it is determined by diffuse lighting at hit point. */
...
/* ========================================================= */ 
/* ========================================================= */ 
/* === CREATED COLORING FUNCTIONS and STAGES => create.c === */ 
/* ========================================================= */ 
/* ========================================================= */ 
